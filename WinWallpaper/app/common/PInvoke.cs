...
namespace WinWallpaper.app.common
{
    ...
    {
        const string DS2Native = @"DS2Native.dll";
        ...
        [DllImport("user32.dll")]
        public static extern IntPtr GetDC(int x, int y, int width, int height);
        ...
        [DllImport(DS2Native, ExactSpelling = false)]
        ...
        [DllImport(DS2Native, ExactSpelling = false)]
        public static extern IntPtr DS2_GetDesktopListViewHWND();
    }
