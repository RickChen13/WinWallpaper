...
} from "@/app/components/background/backgroundConfig";
...
class Component extends BaseViews {
  ...
  public vue() {
    const vue = defineComponent({
      ...
      data() {
        let imgArr = backgroundConfig.imgArr;
        let list: List = [
          {
            class: "",
            path: "",
      ...
      methods: {
        ...
        async init() {
          ...
          if (this.params.isMobile) {
            this.imgArr = mobileBackgroundConfig.imgArr;
          } else {
            this.imgArr = backgroundConfig.imgArr;
          }
