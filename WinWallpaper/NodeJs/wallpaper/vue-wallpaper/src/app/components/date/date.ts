        ...
        setDanmaku() {
          ...
          switch (true) {
            case this.timeIndex <= 0:
              EventBus.emit("danmaku", this.date);
              this.timeIndex = 16;
              break;
            case this.timeIndex == 10:
              EventBus.emit("danmaku", this.lunar);
              break;
            case this.timeIndex == 15:
              EventBus.emit("danmaku", this.gzDate);
              break;
            default:
              EventBus.emit("danmaku", this.His);
              break;
          }
        },
      },
