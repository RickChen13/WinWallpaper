                    ...
                    if (this.audioCanvas != undefined) {
                        if (this.params.audioCanvas.lineStyle == 1) {
                            for (let i = 0; i < 120; i++) {
                                ...
                                w1 = Math.max(w1, w2);
                                this.waveArr[i] = w1 = Math.min(w1, 1.2);
                                let w =
                            ...
                            for (let i = 0; i < 128; i++) {
                                let w1 = arr[i] ? (arr[i] > 0.01 ? arr[i] : 0.01) : 0.01;
                                let height =
                                    this.h *
                                    Math.min(
                                        w1 * (this.params.audioCanvas.lineConfig.range * 0.1) * 0.1,
                                        1
                                    );
                                this.arr1.push({
                ...
                async darw(arr: any) {
                    if (
                        ...
                        if (this.params.audioCanvas.lineStyle == 0) {
                            count = 1;
                        } else if (this.params.audioCanvas.lineStyle == 1) {
                            count = 120;
                        }
